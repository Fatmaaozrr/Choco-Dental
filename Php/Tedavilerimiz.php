...
<body>
<section class="tedaviler">
    <div class="tedaviler-container">
        <h2>Tedavilerimiz</h2>
        <p class="aciklama">
            Çocukların diş sağlığı için özel olarak tasarlanmış tedavi yöntemlerimizle, onlara sağlıklı ve mutlu gülüşler sunuyoruz. Her tedavi, çocukların ihtiyaçlarına uygun şekilde planlanır ve eğlenceli bir ortamda gerçekleştirilir.
        </p>
